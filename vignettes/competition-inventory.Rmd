...
Within `TreeCompR` it is possible to easily derive size-distance-dependent competition indices based on inventory data. This data can be collected in the field, or derived or modeled from 3D point clouds. Depending on the input data, there are some necessary pre-processing steps. We prepared two tutorials for processing laser scanning data to obtain appropriate inventory data:
...
#> ---------------------------------------
#>     id      x      y    dbh
#> 1    1 15.181 -2.979 35.275
#> 2    2 13.097  0.193 20.068
#> 3    3 12.633 -9.445 35.333
#>    ...    ...    ...    ...
#> 46  51 -1.639 -4.842 12.605
#> 47  52 -6.409 -4.722  6.035
#> 48  53 -7.485 -7.619 20.065
```
