...
lookup_results <- lookup %>% purrr:pmap(compete_pc)

lookup_results <- as.data.frame(do.call(rbind, lookup_results))
colnames(lookup_results) <- c('Tree_ID', 'CI_cone')
```
